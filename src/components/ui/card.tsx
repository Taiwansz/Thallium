...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-md border border-border bg-card/80 backdrop-blur-md text-card-foreground shadow-2xl relative overflow-hidden group",
      className
    )}
    {...props}
  >
    {/* Subtle spectral green line at the top to fit the Thallium theme */}
